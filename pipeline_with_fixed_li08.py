...
e.g. mpirun -np 5 python pipeline_with_fixed_li08.py --nthreads 4 --subvol "0_0_0"
...
if __name__ == "__main__":
    ...
    pipeline.run()
    pipeline.write(f"/mnt/home/snewman/ceph/pipeline_results/pipeline_fixed_li08_{subvolume}.hdf5", verbose=0)